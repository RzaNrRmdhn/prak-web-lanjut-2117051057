...
<?= $this->section('content') ?>
    <center>
        <h1>List User</h1>
        <h1><a class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50" href="<?php echo base_url('user/create')?>">
